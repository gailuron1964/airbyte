...
import pytest
from source_merge.source import MergeStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MergeStream, "path", "v0/example_endpoint")
    mocker.patch.object(MergeStream, "primary_key", "test_primary_key")
    mocker.patch.object(MergeStream, "__abstractmethods__", set())
